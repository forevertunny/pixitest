...
function TextInput( options )
{
    ...
    var textContainer = this.textContainer = new ScrollingContainer( {
        scrollX: !multiLine,
        scrollY: multiLine,
    ...
    this.focus = function ()
    {
        if ( !this._focused )
        {
            ...
            this._pui_tempInput.addEventListener( 'textInput', inputEvent, false );
    ...
    this.blur = function ()
    {
        if ( this._focused )
        {
            ...
            this._pui_tempInput.removeEventListener( 'textInput', inputEvent );
